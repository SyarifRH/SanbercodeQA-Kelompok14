...
class TestPIMEmployeeList(unittest.TestCase):
    ...
    def test_HRM_01(self):
        ...
        time.sleep(1)
        driver.find_element(By.XPATH, element.search_employee_by_name).send_keys("Dinda") #masukkan nama employee
        time.sleep(1)
    ...
    def test_HRM_02(self):
        ...
        driver.find_element(By.LINK_TEXT,element.employee_list).click() #klik Employee list
        time.sleep(1)
        driver.find_element(By.CSS_SELECTOR, element.search_employee_by_Id).send_keys("0267") #masukkan employee id
        time.sleep(1)
        driver.find_element(By.CSS_SELECTOR, element.search_button).click() # klik search button
        time.sleep(2)
